...
var rt = (e, t, n) =>
  t in e
    ...
    : (e[t] = n);
var ye = (e, t, n) => rt(e, typeof t != "symbol" ? t + "" : t, n);
function _e(e, t) {
  return function () {
...
const at = G("string"),
  ...
  mt = C("URLSearchParams"),
  [yt, wt, bt, gt] = ["ReadableStream", "Request", "Response", "Headers"].map(
    C,
  ),
  Et = (e) =>
...
const It = (e) => {
  ...
  Ht = C("AsyncFunction"),
  Mt = (e) => e && (X(e) || x(e)) && x(e.then) && x(e.catch),
  qe = ((e, t) =>
    e
      ? setImmediate
      : t
...
function Q(e, t, n) {
  ...
  function l(p, y, h) {
    ...
    return se(p) ? !0 : (t.append(ge(h, y, o), u(p)), !1);
  }
  const d = [],
    w = Object.assign($t, {
      defaultVisitor: l,
...
const Je = {
  ...
  Wt = typeof URLSearchParams < "u" ? URLSearchParams : fe,
  Kt = typeof FormData < "u" ? FormData : null,
  Gt = typeof Blob < "u" ? Blob : null,
  Xt = {
    isBrowser: !0,
    classes: { URLSearchParams: Wt, FormData: Kt, Blob: Gt },
  ...
  Yt = (de && window.location.href) || "http://localhost",
  en = Object.freeze(
    ...
    return (
      ...
      f
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = rn(s[i])),
          !c)
    );
  }
...
class A {
  ...
  set(t, n, r) {
    ...
    else if (a.isString(t) && (t = t.trim()) && !un(t)) i(an(t), n);
...
const Ge = (e) => {
    ...
    (t.headers = i = A.from(i)),
      (t.url = ve(Ke(t.baseURL, t.url), e.params, e.paramsSerializer)),
      c &&
        i.set(
          "Authorization",
          "Basic " +
    ...
    if (t || n) {
      ...
      const o = function (u) {
        if (!s) {
          ...
          r.abort(
            l instanceof m ? l : new q(l instanceof Error ? l.message : l),
          );
        }
      };
      let i =
  ...
  Tn = async function* (e, t) {
    for await (const n of On(e)) yield* Rn(n, t);
  },
  On = async function* (e) {
  ...
  Ce = 64 * 1024,
  ie = Xe && Qe(() => a.isReadableStream(new Response("").body)),
...
const Cn = async (e) => {
  ...
  Nn =
    ...
    (async (e) => {
      ...
      let E = Sn([s, o && o.toAbortSignal()], i),
        p;
      const y =
        E &&
        E.unsubscribe &&
  ...
  Ze = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !kn(n) && ((r = ae[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
function Ne(e) {
  return (
    ...
    Ze.getAdapter(e.adapter || z.adapter)(e).then(
      function (r) {
        return (
          ne(e),
...
const ce = { assertOptions: _n, validators: pe },
  k = ce.validators;
class L {
  constructor(t) {
    (this.defaults = t),
...
class Bn {
  ...
  getTokenExpiration() {
    ...
    const n = this.decodeToken(t),
      ...
      s = n.exp - r;
    return console.log(`Time to refresh: ${s}`), s;
  }
}
const U = new Bn(),
  D = g.create({ baseURL: "https://easydev.club/api/v1" });
D.interceptors.request.use(
  async (e) => {
    const t = U.getToken(),
      n = U.getTokenExpiration();
    return (
      t && n < 360 && (await tt()),
...
D.interceptors.response.use(
  ...
  async (e) => {
    ...
    if (
      ...
      e.response.status === 401 && e.config && !e.config._isRetry)
    ) {
      t._isRetry = !0;
      try {
        if (localStorage.getItem("refreshToken"))
          return await tt(), D.request(t);
      } catch {
        console.error(`Ошибка при обновлении токена: ${e.response}`), Dn();
      }
    }
...
const jn = async (e) => {
    try {
      const t = await D.post("/auth/signup", e);
  ...
  qn = async (e) => {
    try {
      const t = await D.post("/auth/signin", e);
      if (t.status === 200)
        return (
          U.setToken(t.data.accessToken),
      ...
      throw (
        (t.status === 400
          ? alert(
              "Bad Request: Ошибка десериализации запроса или неверный ввод.",
            )
          : t.status === 401
  ...
  Dn = async () => {
    try {
      await D.post("/user/logout"),
        U.removeToken(),
        localStorage.removeItem("refreshToken");
    } catch (e) {
      throw (console.error("Ошибка при логауте: " + e), new Error());
    }
  },
  In = async () => {
    try {
      return console.log(U.getToken()), (await D.get("/user/profile")).data;
    } catch (e) {
      throw (console.error(`Ошибка при загрузке профиля: ${e}`), new Error());
    }
  },
  tt = async () => {
    try {
      const e = await g.post("https://easydev.club/api/v1/auth/refresh", {
        refreshToken: localStorage.getItem("refreshToken"),
      });
      return (
        U.setToken(e.data.accessToken),
        localStorage.setItem("refreshToken", e.data.refreshToken),
        e.data.accessToken
      );
    } catch (e) {
      throw (console.log(`Ошибка при обновлении токена: ${e}`), e);
    }
  };
export { qn as a, In as f, Dn as l, tt as r, jn as s, U as t };
